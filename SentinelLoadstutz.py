...
#                    print("making new dir at ", tmp_tile_filejp2)
#                    os.makedirs(os.path.dirname(tmp_tile_filejp2))
                ...
                if count ==0:
                    downloadFile(url, 'sentdowns%s%s.jp2' % (sp['uuid'], bandName), self.user, self.password)
                count = 1
